...
class RAGService:
    ...
    async def stream_chat(self, session_id: str, user_message: str) -> AsyncGenerator[str, None]:
        ...
        system_prompt = (
            ...
            f"- Follower Count: {f'{video_a.follower_count:,}' if video_a.follower_count else 'N/A'}\n"
            ...
            f"- Follower Count: {f'{video_b.follower_count:,}' if video_b.follower_count else 'N/A'}\n"
